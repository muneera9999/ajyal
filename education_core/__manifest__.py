...
###################################################################################
{
    ...
    'author': 'SaasCloud For Information Systems',
    'company': 'SaasCloud For Information Systems',
    'maintainer': 'SaasCloud For Information Systems',
    ...
    'data': [
        ...
        # 'data/db_expire_date_crone.xml',

        'wizard/student_transfer_wizard.xml',
        ...
        'reports/students_list.xml',
        'reports/siblings_report.xml',
        'views/student_propraties.xml',
        'reports/division_students_report.xml',
        'reports/student_data_report.xml',

        'views/education_parent_view.xml',
        'views/accessories.xml',
        'views/education_episode.xml',
    ],
    # 'demo': [

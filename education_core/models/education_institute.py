...
class EducationInstitute(models.Model):
    ...
    header_logo = fields.Binary( string="header Logo", readonly=False)
    footer_logo = fields.Binary( string="footer Logo", readonly=False)
...
class EducationResPartner(models.Model):
    ...
    #     res = super(EducationResPartner, self)._get_contact_name(partner, name)
    #     return "%s" % (name)
